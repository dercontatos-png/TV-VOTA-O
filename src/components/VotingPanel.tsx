...
export default function VotingPanel({
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8" id="voting-panel-container">
      ...
      {/* Sponsor Banner */}
      {config?.sponsorName && (
        <div className="mb-8 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 border border-blue-700/50 rounded-3xl p-8 shadow-xl flex flex-col items-center gap-6 text-center text-white overflow-hidden relative">
          {/* Abstract elements */}
          ...
          {config.sponsorLogoUrl ? (
            <div className="w-40 h-40 sm:w-56 sm:h-56 shrink-0 flex items-center justify-center relative z-10 drop-shadow-xl">
          ...
          <div className="relative z-10 w-full flex flex-col items-center justify-center">
            <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-blue-200 bg-blue-950/50 px-4 py-1.5 rounded-full border border-blue-400/30 shadow-sm inline-block mb-4 mx-auto text-center">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-xs text-gray-500 truncate flex items-center gap-1">
                      {getTeamLogoUrl(player.team) ? (
                        <img src={getTeamLogoUrl(player.team)} alt={player.team} className="w-3.5 h-3.5 object-contain shrink-0" />
                      ) : (
